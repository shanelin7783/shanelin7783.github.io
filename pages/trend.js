...
const MARKSIX_N1 = dynamic(import("@components/marksix_n1/TrendContainer"), { loading: () => <MARKSIX_N1Loading /> });
const MARKSIX_T1 = dynamic(import("@components/marksix_t1/TrendContainer"), { loading: () => <MARKSIX_T1Loading /> });
const PC28 = dynamic(import("@components/pc28/TrendContainer"), { loading: () => <PC28Loading /> });
const PC28_N1 = dynamic(import("@components/pc28_n1/TrendContainer"), { loading: () => <PC28_N1Loading /> });
const SSC_N1 = dynamic(import("@components/ssc_n1/TrendContainer"), { loading: () => <SSC_N1Loading /> });
const SSC_N2 = dynamic(import("@components/ssc_n2/TrendContainer"), { loading: () => <SSC_N2Loading /> });
const SSC_T1 = dynamic(import("@components/ssc_t1/TrendContainer"), { loading: () => <SSC_T1Loading /> });
...
// Trend.getInitialProps = async ({ store }) => {

...
import { As5fhk6n2Header } from "./Header";
import { As5fhk6n2MultipleSelect } from "./MultipleSelect";
import { As5fhk6n2Game } from "./GameCenter";
...
import { As5fhk6n2FirstTimeDialog } from "./FirstTimeDialog";

export const As5fhk6n2 = () => {
    ...
    return (
        <LayoutContainer>
            ...
            <footer>
                <div className="bottom_btnbox">
                    <button onClick={() => onGoPage("betRecord")}>
                        ...
                        输赢
                        <span style={{ display: showBadge ? "block" : "none" }}>
            ...
            {showMultipleMenu && <As5fhk6n2MultipleSelect ref={multipleMenuRef} />}
